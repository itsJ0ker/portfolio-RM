      ...
      <div className="relative mx-auto max-w-[1500px] px-5 pb-10 pt-16 sm:px-10">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr_1fr]">
          <div className="footer-item">
            ...
            <p className="mt-5 max-w-sm font-serif text-xl font-light leading-relaxed text-parchment-100">Dr. Ritika Malik</p>
            <p className="mt-1 font-sans text-sm font-light text-slate-cold">{profile.headlineShort}</p>
            <p className="mt-4 font-sans text-sm italic text-gold-300/80">
