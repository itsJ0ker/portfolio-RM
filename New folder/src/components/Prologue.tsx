  ...
  return (
    <section ref={rootRef} id="prologue" className="relative scroll-mt-24 py-24 sm:py-36">
      ...
      <div className="mx-auto grid max-w-[1500px] items-start gap-14 px-5 sm:px-10 lg:grid-cols-[1fr_0.85fr]">
        <div>
          <SectionHeading chapterLabel="Prologue · The Advocate" num="I" title="The Woman Beneath the Gown" />
          <div className="space-y-6">
            {aboutParts.map((p, i) => (
              <p key={i} className="prologue-paragraph max-w-xl font-serif text-lg font-light leading-[1.85] text-parchment-200/90 sm:text-xl">
                <span className="mr-3 font-serif text-4xl leading-none text-gold-400">“</span>
                {p.text}
              </p>
            ))}
          </div>
