...
export default function Summons() {
  ...
  return (
    <section ref={rootRef} id="summons" className="relative scroll-mt-24 py-24 sm:py-36">
      ...
      <div className="summons-inner relative mx-auto max-w-[1500px] px-5 sm:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="summons-copy mt-5 font-serif text-4xl font-light leading-tight text-parchment-50 sm:text-6xl">
            The Court Is Now
            <br />
            <span className="text-gold-gradient italic">In Session.</span>
          </h2>
          <p className="summons-copy mx-auto mt-6 max-w-xl font-sans text-sm font-light leading-relaxed text-slate-cold sm:text-base">
            For scholarly collaboration, peer review, guest lectures, editorial roles, or a partnership in shaping the legal minds of tomorrow — address the Bench directly.
          </p>
          ...
          <div className="summons-copy mt-10 grid gap-4 sm:grid-cols-3">
            <a href={`mailto:${profile.email}`} data-hover target="_blank" rel="noreferrer" className="gilt-card group p-6">
              ...
              <p className="mt-2 break-all font-serif text-sm text-parchment-100 transition-colors group-hover:text-gold-200 sm:text-base">{profile.email}</p>
            </a>
          ...
          <form onSubmit={submit} className="summons-copy relative mx-auto mt-14 max-w-xl">
            {sent ? (
              ...
              <div className="space-y-4 border border-gold-500/20 bg-ink-900/70 p-6 text-left backdrop-blur sm:p-8">
                ...
                <button type="submit" className="btn-gold w-full px-8 py-4 font-cinzel text-[11px] uppercase tracking-[0.28em] text-ink-950">
                  File &amp; Submit
                </button>
              </div>
            )}
